        ...
        <section className="premium-surface rounded-3xl p-7 sm:p-9 w-full max-w-lg text-center" role="alert">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-2.5 justify-center">
            <button
              type="button"
              onClick={this.reset}
              className="interactive-press inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-card px-4 py-2.5 text-sm font-semibold text-purple-300 hover:bg-accent"
            >
            ...
            <button
              type="button"
              onClick={this.goHome}
              className="interactive-press inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-white hover:bg-primary/90"
            >
